...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="{{asset('assets/login_assets/register/fonts/material-icon/css/material-design-iconic-font.min.css')}}">

    <!-- Main css -->
    <link rel="stylesheet" href="{{asset('assets/login_assets/register/css/style.css')}}">
</head>
<body>
    <div class="main">
        @if (session('message'))
    ...
    <section class="sign-in">
            <div class="container">
                ...
                <div class="signin-image">
                    <figure><img src="{{asset('assets/login_assets/register/images/signin-image.jpg')}}" alt="sing up image"></figure>
                    <a href="register" class="signup-image-link">Create an account</a>
                </div>
            </div>
        </div>
