...
<!-- Mirrored from connectme-html.themeyn.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Sep 2023 07:50:17 GMT -->
                        ...
                        <div class="tab-pane" id="active-contacts" tabindex="0" role="tabpanel">
                            <ul class="tyn-aside-list">
                                ...
                                <li class="tyn-aside-item js-toggle-main">
                                    <div class="tyn-media-group">
                                        <div class="tyn-media tyn-size-lg">
                                            <img src="<?php echo $this->url; ?>images/avatar/6.jpg" alt="">
                                        </div>
                                        <div class="tyn-media-col">
                                            <div class="tyn-media-row">
                                ...
                                <li class="tyn-aside-item js-toggle-main">
                                    <div class="tyn-media-group">
                                        <div class="tyn-media tyn-size-lg">
                                            <img src="<?php echo $this->url; ?>images/avatar/10.jpg" alt="">
                                        </div>
                                        <div class="tyn-media-col">
                                            <div class="tyn-media-row">
                        ...
                        <div class="tab-pane" id="archived-chats" tabindex="0" role="tabpanel">
                            <ul class="tyn-aside-list">
                                ...
                                <li class="tyn-aside-item js-toggle-main">
                                    <div class="tyn-media-group">
                                        <div class="tyn-media tyn-size-lg">
                                            <img src="<?php echo $this->url; ?>images/avatar/9.jpg" alt="">
                                        </div>
                                        <div class="tyn-media-col">
                                            <div class="tyn-media-row">
                                ...
                                <div class="tyn-reply-bubble">
                                    <div class="tyn-reply-media">
                                        <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                            <img src="<?php echo $this->url; ?>images/gallery/video/hr-6.jpg" class="tyn-image" alt="">
                                ...
                                <div class="tyn-reply-bubble">
                                    <div class="tyn-reply-media">
                                        <a href="images/gallery/chat/1.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                            <img src="<?php echo $this->url; ?>images/gallery/chat/thumb-1.jpg" class="tyn-image" alt="">
                                        </a>
                                        <a href="images/gallery/chat/2.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                            <img src="<?php echo $this->url; ?>images/gallery/chat/thumb-2.jpg" class="tyn-image" alt="">
                                        </a>
                                        <a href="images/gallery/chat/3.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                            <img src="<?php echo $this->url; ?>images/gallery/chat/thumb-3.jpg" class="tyn-image" alt="">
                                        </a>
                                        <a href="images/gallery/chat/4.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                            <img src="<?php echo $this->url; ?>images/gallery/chat/thumb-4.jpg" class="tyn-image" alt="">
                                        </a>
                                        <a href="images/gallery/chat/5.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                            <img src="<?php echo $this->url; ?>images/gallery/chat/thumb-5.jpg" class="tyn-image" alt="">
                                        </a>
                                    </div>
                                    <ul class="tyn-reply-tools">
                                        <li>
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-4">
                                                <a href="images/gallery/chat/6.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                                    <img src="<?php echo $this->url; ?>images/gallery/chat/thumb-6.jpg" class="tyn-image" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div><!-- .tab-pane -->
                                    <div class="tab-pane" id="chat-media-videos" tabindex="0">
                                        <div class="row g-3">
                                            <div class="col-6">
                                                <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                    <img src="<?php echo $this->url; ?>images/gallery/video/hr-1.jpg" class="tyn-image" alt="">
                                                    <div class="tyn-video-icon">
                                                        <!-- play-fill -->
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                            <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                            ...
                                            <div class="col-6">
                                                <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                    <img src="<?php echo $this->url; ?>images/gallery/video/hr-2.jpg" class="tyn-image" alt="">
                                                    <div class="tyn-video-icon">
                                                        <!-- play-fill -->
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                            <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                            ...
                                            <div class="col-6">
                                                <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                    <img src="<?php echo $this->url; ?>images/gallery/video/hr-3.jpg" class="tyn-image" alt="">
                                                    <div class="tyn-video-icon">
                                                        <!-- play-fill -->
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                            <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                            ...
                                            <div class="col-6">
                                                <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                    <img src="<?php echo $this->url; ?>images/gallery/video/hr-4.jpg" class="tyn-image" alt="">
                                                    <div class="tyn-video-icon">
                                                        <!-- play-fill -->
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                            <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                            ...
                                            <div class="col-6">
                                                <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                    <img src="<?php echo $this->url; ?>images/gallery/video/vr-5.jpg" class="tyn-image" alt="">
                                                    <div class="tyn-video-icon">
                                                        <!-- play-fill -->
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                            <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                        ...
                                        <ul class="tyn-media-list gap gap-3">
                                                ...
                                                <a href="#" class="tyn-links">
                                                    <div class="tyn-media-group">
                                                        <div class="tyn-media tyn-size-xl">
                                                            <img src="<?php echo $this->url; ?>images/gallery/chat/thumb-7.jpg" alt="">
                                                        </div>
                                                        <div class="tyn-media-col">
                                            ...
                                            <li>
                                                <a href="#" class="tyn-links">
                                                    <div class="tyn-media-group">
                                                        <div class="tyn-media tyn-size-xl">
                                                            <img src="<?php echo $this->url; ?><?php echo $this->url; ?>images/gallery/chat/thumb-8.jpg" alt="">
                                                        </div>
                                                        <div class="tyn-media-col">
