...
<!-- Mirrored from connectme-html.themeyn.com/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Sep 2023 07:50:54 GMT -->
...
<head>
    ...
    <title>Register | ConnectMe | Chat Application HTML Template</title>
                        ...
                        <div class="card border-0">
                            <div class="p-4">
                                ...
                                <div class="row g-3 gx-4">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" name="name"  class="form-control" id="username" placeholder="yourname">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="form-label" for="repeat-password">Username</label>
                                            <div class="form-control-wrap">
                                                <input type="text" name="username" class="form-control" id="repeat-password" placeholder="Enter Username">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" required name="muteFor" id="privacy-term-agree">
                                            <label class="form-check-label" for="privacy-term-agree"> I agree with <a href="#">privacy policy &amp; terms</a>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100" name="submit_btn" type="submit" >Account Register</button>
                                    </div>
                                </div><!-- .row -->
                                </form>
                            </div>
